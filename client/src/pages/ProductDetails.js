        ...
        <div className="col-md-6 product-details-info">
          ...
          <div className="cart-options">
            <div className="cart-product-quantity">
              <button
                class="btn btn-secondary ms-1 btn-decrement"
                onClick={() => {
                  productCartQuantity > 1
                    ? setProductCartQuantity(productCartQuantity - 1)
                    : setProductCartQuantity(productCartQuantity);
                }}
              >
                -
              </button>
              <div className="productCartQuantity">{productCartQuantity}</div>
              <button
                class="btn btn-secondary ms-1 btn-increment"
                onClick={() => {
